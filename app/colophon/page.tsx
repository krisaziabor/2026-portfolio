...
const footer = {
  ...
  builtWith: 'Next.js, Cursor, and Claude',
};
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F9F8F6' }}>
      <div className="flex items-center justify-center min-h-screen py-12 px-8">
        <div className="bg-white shadow-sm grid grid-cols-2 p-12 max-w-6xl w-full" style={{ color: '#8B6B5A', borderRadius: '4px', border: '1px solid #DBD8D8' }}>
          {/* Left Column */}
          <div 
            className="flex flex-col justify-between h-full pr-8 font-[family-name:var(--font-lector)] lector-font" 
            style={{ 
              fontSize: '15px'
            }}
          >
            ...
            {/* Bio Paragraphs */}
            <div className="flex flex-col gap-6 my-8" style={{ color: '#574C41' }}>
              <p>{bio[0]}</p>
              <p>
                I study Computer Science and Fine Arts at{' '}
                <a href="https://yale.edu" className="hover:opacity-80" style={{ color: '#8B6B5A' }} target="_blank" rel="noopener noreferrer">
                  Yale
                </a>{' '}
                and lead the university&apos;s design community & studio, forming & overseeing the largest ever designer cohort in{' '}
                <a href="https://designatyale.com" className="hover:opacity-80" style={{ color: '#8B6B5A' }} target="_blank" rel="noopener noreferrer">
                  Design at Yale&apos;s
                </a>{' '}
                history. I&apos;ve previously worked at{' '}
                <a href="https://kensho.com" className="hover:opacity-80" style={{ color: '#8B6B5A' }} target="_blank" rel="noopener noreferrer">
                  Kensho
                </a>
                ,{' '}
                <a href="https://spglobal.com" className="hover:opacity-80" style={{ color: '#8B6B5A' }} target="_blank" rel="noopener noreferrer">
                  S&P Global
                </a>
                ,{' '}
                <a href="https://fidelity.com" className="hover:opacity-80" style={{ color: '#8B6B5A' }} target="_blank" rel="noopener noreferrer">
                  Sea12
                </a>
                ,{' '}
                <a href="https://fidelity.com" className="hover:opacity-80" style={{ color: '#8B6B5A' }} target="_blank" rel="noopener noreferrer">
                ...
                , and{' '}
                <a href="https://cyclio.com" className="hover:opacity-80" style={{ color: '#8B6B5A' }} target="_blank" rel="noopener noreferrer">
                  cyclio
                </a>
                .
              </p>
            ...
            {/* Footer Metadata */}
            <div className="flex flex-col gap-1 text-sm" style={{ color: '#9B958F' }}>
      ...
      {/* Footer Navigation */}
      <div 
        className="flex justify-center items-center gap-4 pb-8 font-[family-name:var(--font-lector)] lector-font"
      >
        <Link
          href="/"
